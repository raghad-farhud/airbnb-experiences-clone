...
export default function Card(props) {
    return (
        <div className="card">
            ...
            <div className="card-status">{ props.openSpots == 0 ? "SOLD OUT" : `${props.openSpots} Remains` }</div>
            <div className="card-rate">
                ...
                <span>
                    <span className="rate">{props.rating}</span> ({props.reviewCount}) - {props.location}
                </span>
            </div>
